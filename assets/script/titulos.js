...
document.title = '.:: Sistema para Gestión de Préstamos de Dinero ::.';		
$(".current-year").text('2024 - ' + new Date().getFullYear() + ' CopyRight. Todos los Derechos Reservados. Ing. Ruben D. Chirinos. R');
...
function getTime() 
  {
    ...
    var fecha2 = today.getDate() + "-" + num[today.getMonth()] + "-" + today.getFullYear();
