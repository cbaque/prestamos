                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h5 class="card-subtitle text-dark alert-link"><i data-feather="list"></i> Préstamos por Usuarios</h5>
                                    </div>                  
                                </div>
                            </div>

    <div class="widget-content widget-content-area">                                
        <form class="form form-material" method="post" action="#" name="prestamosxusuarios" id="prestamosxusuarios">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group has-feedback">
                    <label class="control-label">Seleccione Usuario: <span class="symbol required"></span></label>
        ...
        <button type="button" onClick="BuscarPrestamosxUsuarios()" id="BotonBusqueda" class="btn btn-primary"><i data-feather="search"></i> Realizar Búsqueda</button>
                                    </div>
            ...
            <div id="muestraprestamosxusuarios"></div>
