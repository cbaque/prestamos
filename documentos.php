...
<!--############################## MODAL PARA GESTION DE DOCUMENTOS ######################################-->
<!-- Modal -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="exampleModalLabel"><i class="text-white" data-feather="save"></i> Gestión de Documentos</h5>
            </div>
                ...
                <div class="row layout-top-spacing">
                    <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h5 class="card-subtitle text-dark alert-link"><i data-feather="list"></i> Tipos de Documentos</h5>
                                    </div>                  
                                </div>
                            </div>
                        ...
                        <div class="table-responsive mb-4 mt-4">
                            <div class="btn-group">
                                <button type="button" class="btn waves-effect waves-light btn-primary" data-toggle="modal" data-target="#myModalDocumento" title="Agregar" data-backdrop="static" data-keyboard="false"><i data-feather="file-plus"></i> Agregar</button>
