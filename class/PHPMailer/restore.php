                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h5><i data-feather="align-justify"></i> Restauración de Base de Datos</h5>
                                    </div>                  
                                </div>
                            </div>
...
$usuario = "jvdelicias_prestamos"; //valor predeterminado
$passwd  = "95*QiE-fmN)w"; //valor predeterminado
$bd      = "jvdelicias_prestamos"; //parametro obligatorio   
